...
// import { DelonLocaleService } from '@shared/theme';
import { InputNumber, InputBoolean } from '@shared/util';
...
@Component({
  ...
  template: `
  <nz-badge *ngIf="data?.length <= 0" [nzCount]="count" [nzOverflowCount] ="100">
  ...
  <nz-popover *ngIf="data?.length > 0"
    ...
    <div nz-popover class="item">
      <nz-badge [nzCount]="count" [nzOverflowCount] = "100">
        <i nz-icon type="bell"></i>
      </nz-badge>
    </div>
